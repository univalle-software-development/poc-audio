  ...
  return (
    <footer className="bg-white dark:bg-gray-900 mt-auto">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-3xl sm:py-12 md:flex md:items-center md:justify-between">
          ...
          <p className="mt-8 text-center text-sm/6 text-gray-600 md:order-1 md:mt-0 dark:text-gray-400">
            &copy; {new Date().getFullYear()} Universidad del Valle, PROYECTO INTEGRADOR II-01. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
